<?php
class AutoSitemap_Action extends Typecho_Widget implements Widget_Interface_Do
{
	public function action()
	{
		...
		echo "<?xml-stylesheet type='text/xsl' href='" . $options->pluginUrl . "/AutoSitemap/sitemap.xsl'?>\n";
